...
class Version {
  ...
  Version(this.major, this.minor, this.patch,
    ...
    if (major == null) throw ArgumentError("major must not be null");
    if (minor == null) throw ArgumentError("minor must not be null");
    if (patch == null) throw ArgumentError("patch must not be null");
    if (_preRelease == null) {
    ...
    if (build == null) throw ArgumentError("build must not be null");
